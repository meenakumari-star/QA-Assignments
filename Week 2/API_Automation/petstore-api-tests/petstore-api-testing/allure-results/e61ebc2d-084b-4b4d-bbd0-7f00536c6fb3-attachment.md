...
- Name: advanced\schema-validation.spec.ts >> Schema Validation >> findByStatus response is array of valid Pets
- Location: tests\advanced\schema-validation.spec.ts:57:7
