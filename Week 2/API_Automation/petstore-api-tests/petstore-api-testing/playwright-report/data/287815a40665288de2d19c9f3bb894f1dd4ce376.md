...
- Name: integration\e2e-workflow.spec.ts >> End-to-End Workflows >> Inventory remains accessible after pet/order operations
- Location: tests\integration\e2e-workflow.spec.ts:80:7
