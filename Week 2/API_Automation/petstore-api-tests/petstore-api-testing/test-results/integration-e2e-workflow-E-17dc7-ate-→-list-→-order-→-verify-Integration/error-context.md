...
- Name: integration\e2e-workflow.spec.ts >> End-to-End Workflows >> Full pet adoption flow: create → list → order → verify
- Location: tests\integration\e2e-workflow.spec.ts:22:7
