...
- Name: advanced\error-handling.spec.ts >> Error Handling >> GET /store/order/{id} — 404 when order does not exist
- Location: tests\advanced\error-handling.spec.ts:26:7
