...
- Name: store\store-orders.spec.ts >> Store Order Operations >> GET /store/inventory — should return inventory object
- Location: tests\store\store-orders.spec.ts:24:7
