...
- Name: integration\e2e-workflow.spec.ts >> End-to-End Workflows >> User lifecycle: register → login → update → logout → delete
- Location: tests\integration\e2e-workflow.spec.ts:50:7
